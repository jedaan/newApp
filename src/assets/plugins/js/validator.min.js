...
+ function(a) {
    ...
    c.INPUT_SELECTOR = ':input:not([type="submit"], button):enabled:visible', c.DEFAULTS = {
        ...
        let c = this.options.html ? "html" : "text";
        this.defer(b, function() {
            let d = b.closest(".form-group"),
        ...
        if (this.options.disable) {
            let b = a('button[type="submit"], input[type="submit"]').filter('[form="' + this.$element.attr("id") + '"]').add(this.$element.find('input[type="submit"], button[type="submit"]'));
